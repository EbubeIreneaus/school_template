...
function Footer() {
  return (
    <footer className="bg-slate-900  text-white/75 lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h2 className="text-xl lg:text-2xl font-extrabold flex items-center ">
             OURSCHOOL INTL ACADEMY
            </h2>
            <p>An Innovative Agency For Forward-thinking Brands.</p>
          </div>
          {/* <!-- Products section --> */}
          <div>
      ...
      <div className="bg-black/5 p-6 text-center flex items-center gap-2 justify-center">
